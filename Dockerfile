...
RUN         /root/.pyenv/versions/app/bin/python /srv/app/octocolumn/manage.py manage.py makemigrations --noinput
RUN         /root/.pyenv/versions/app/bin/python /srv/app/octocolumn/manage.py manage.py migrate --settings=config.settings.deploy --noinput
