        ...
        success: function(json) {
            ...
            for( post in posts ) {
                ...
                if( n%2 == 0 ) {
                    ...
                    var tag = date_div_right_1 + post.created_date + date_div_right_2 + post_img + date_div_right_3 + post.title + date_div_right_4;
                    
                    $(".history_bar").append( tag );

                } else {

                    var tag = date_div_left_1 + post.created_date + date_div_left_2 + post_img + date_div_left_3 + post.title + date_div_left_4;
