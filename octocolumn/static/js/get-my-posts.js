...
function get_my_posts(which){    //프로필 페이지에서 자신이 쓴 글들을 보여준다.
    ...
    if(which == "post"){
        ...
        var date_div_right_2 = "</span><div class=\"date_box\" onclick=\"window.location.href=\'\/@author\/-";                         // 작성일 오른쪽 태그 + 이미지 소스 왼쪽 태그
        var date_div_right_3 = "\'\"><div class=\"date_img\" style=\"background:url(";

        var date_div_left_2 = "</span><div class=\"date_box\" onclick=\"window.location.href=\'\/@author\/-";
